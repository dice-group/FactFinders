...
public class RDFTriplizer {
	...
	private static String triplify(Model input) throws IOException {
		...
		String file = "./src/data/testtriples.tsv";
		FileWriter writer = new FileWriter(file);
		FileWriter test = new FileWriter("./src/data/Sum.nt");
...
//
//		Model model= readModel("/home/datascienceadmin/eclipse-workspace/FactFinders/src/data/test.nt");
//
//		triplify(model);
//
//	}
